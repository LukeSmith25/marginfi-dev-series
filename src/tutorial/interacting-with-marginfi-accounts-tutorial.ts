...
const clusterUrl = process.env.MARGINFI_RPC_ENDPOINT as string;
const walletPath = process.env.MARGINFI_WALLET as string;
const environment = process.env.MARGINFI_ENV as string;
